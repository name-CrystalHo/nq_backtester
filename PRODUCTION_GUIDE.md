...
```python
from backtester.data import ProductionDataManager, quick_load_data, show_available_data
...
```python
from backtester.data import quick_load_data
from backtester import Backtester
from backtester.strategies import SimpleMovingAverageStrategy
